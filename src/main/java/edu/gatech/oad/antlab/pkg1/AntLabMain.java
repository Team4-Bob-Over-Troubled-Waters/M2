 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  toPrint += p1.toString("jkilpatrick9");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Anagha Krishnan");
		  toPrint += p2.toString("akrishnan67");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Francine Luo");
		  toPrint += p3.toString("fluo32");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Misha");
                  toPrint += p4.toString("gmat3");
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Yu Hsin Lo");
                  toPrint += p5.toString("ylo39");
                  // adding person 6
                  Person6 p6 = new Person6("Sarah");
                  toPrint += p6.toString("smorrissey3");
